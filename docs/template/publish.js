    ...
    if (items && items.length) {    
        items.forEach(function (item) {
            ...
            if (!hasOwnProp.call(item, 'longname')) {
                ...
                if (members.length) {
                    itemsNav += "<ul class='members' aria-label='Members'>";

                    members.forEach(function (member) {
                        itemsNav += '<li data-type="member" id="' + item.name.replace('/', '_') + '-' + member.name + '-nav">';
                ...
                if (methods.length) {
                    itemsNav += "<ul class='methods' aria-label='Methods'>";
